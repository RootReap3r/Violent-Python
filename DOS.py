'''WARNING
1. This script will spam the Dead Pool Movie in loop and populate your screen with it every 5 seconds.
...
'''DeadPool below - Copy and paste to a notepad file in order for this to work a file must be made with it'''
